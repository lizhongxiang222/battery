...
try:
    ...
    df0 = df[(df['id_station'] == '2c') & (df['id_group']==id_groups[1] ) & (df.index<'2017-10-02 00:00:00')]
    t1=0
    k=1
    ...
    for iGroup in range(2,groupNum+1):
        df2 = df[(df['id_station'] == '2c') & (df['id_group']==id_groups[iGroup-1] ) & (df.index<'2017-10-02 00:00:00')]
        t1=0
        k=1
